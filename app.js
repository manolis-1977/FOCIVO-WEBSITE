const translations = {
  en: {
    ...
    "desktop.tag":"Main application","desktop.title":"FORYMO for Windows","desktop.body":"The full desktop workspace where Focus, Rhythm and Moments come together through Today, Tasks, Routines, Reminders and verified Backup & Recovery.","desktop.meta":"Desktop experience","desktop.cta":"Get release updates","mobile.tag":"In development","mobile.title":"FORYMO Mobile","mobile.body":"A companion experience designed to keep the essentials of your FORYMO workspace close when you are away from your PC.","mobile.meta":"Companion experience","mobile.cta":"Production release will follow testing",
    ...
    "faq.title":"Good questions. Clear answers.","faq.q1":"What is FORYMO?","faq.a1":"FORYMO is a personal productivity system built around Focus, Rhythm and Moments: Tasks support Focus, Routines build Rhythm, and Reminders with Today bring the right things into the right Moments.","faq.q2":"Is FORYMO available in Greek?","faq.a2":"Yes. FORYMO stays FORYMO in every language, while menus and explanations are localized into natural Greek based on meaning, not word-for-word machine translation.","faq.q3":"Is the mobile app available now?","faq.a3":"The mobile companion is in active development and will be released only after the required testing and acceptance steps are complete.","faq.q4":"Can I recover my data?","faq.a4":"The Windows application includes a verified Backup & Recovery workflow designed to create, verify, preview and apply approved recovery backups.",
  ...
  el: {
    ...
    "desktop.tag":"Κύρια εφαρμογή","desktop.title":"FORYMO για Windows","desktop.body":"Ο πλήρης χώρος εργασίας όπου Focus, Rhythm και Moments ενώνονται μέσα από την Ημέρα σου, τις Εργασίες, τις Συνήθειες, τις Υπενθυμίσεις και την επαληθευμένη δημιουργία αντιγράφων ασφαλείας και επαναφορά.","desktop.meta":"Εφαρμογή για υπολογιστή","desktop.cta":"Ενημερώσου για την έκδοση","mobile.tag":"Σε ανάπτυξη","mobile.title":"FORYMO Mobile","mobile.body":"Η συνοδευτική εμπειρία που σχεδιάζεται ώστε να έχεις κοντά σου τα βασικά του FORYMO όταν βρίσκεσαι μακριά από τον υπολογιστή σου.","mobile.meta":"Συνοδευτική εφαρμογή","mobile.cta":"Η τελική έκδοση θα ακολουθήσει μετά την ολοκλήρωση των δοκιμών",
...
setLanguage(localStorage.getItem('focivo-language') || 'en');